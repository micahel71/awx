...
class TestAutoScaling:
    ...
    def test_lost_worker_queue_durability(self):
        ...
        # the first message was lost, because the process was killed while it ran
        # the second two messages in the queue should survive
        assert sum([w.messages_sent for w in self.pool.workers]) == 2
